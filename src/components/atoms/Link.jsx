...
export default function Link({ variant = 'backdrop', href, children, size = 'medium'}) {
    const baseStyles = 'w-fit inline-flex items-center font-medium transition-all duration-300 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed';
